...
PostPilot 是一个面向创作者的多平台内容适配与发布工具。用户在一个界面内完成内容输入、平台版本生成、AI 审查、模拟发布状态查看和账号配置，支持 Windows 下本地化工作流。
...
- 内置 `wechat.md`、`bilibili.md`、`douyin.md` 三份平台风格预设, 启动时会写入本地 `platform-presets` 目录
- 平台账号配置支持：
  - 默认内置 3 个演示平台
  - 自定义新平台配置（手动添加/删除）
